...
export interface PiDesktopApi {
  ...
  deleteSessionForever(workspaceId: string, sessionId: string): Promise<DesktopAppState | null>;
  exportSession(format: "html" | "jsonl"): Promise<string | null>;
  getContextUsage(): Promise<unknown>;
  getSessionStats(): Promise<unknown>;
  getSessionTools(): Promise<unknown>;
  ...
  saveCards(cards: unknown[]): Promise<unknown>;
  getBusinessPrompt(): Promise<string>;
  saveBusinessPrompt(content: string): Promise<string>;
  getTodoRules(): Promise<string>;
  saveTodoRules(content: string): Promise<string>;
  getWikiConfig(): Promise<unknown>;
  ...
  getExtensionsConfig(): Promise<unknown>;
  ...
  removeHook(ruleId: string): Promise<unknown>;
  listSchedulesUI(): Promise<unknown>;
  createScheduleUI(rule: Record<string, unknown>): Promise<unknown>;
  removeScheduleUI(ruleId: string): Promise<unknown>;
  getSessionGroups(): Promise<unknown>;
  createSessionGroup(name: string): Promise<unknown>;
  removeSessionGroup(groupId: string): Promise<unknown>;
  assignSessionGroup(sessionId: string, groupId: string | null): Promise<unknown>;
  updateEntity(entityType: string, entityId: string, updates: Record<string, unknown>): Promise<unknown>;
  costrictStatus(): Promise<unknown>;
}
